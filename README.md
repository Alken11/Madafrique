# Madafrique-platform
All Madafrique services started from a single repository

*Keep in mind this repository is for local development only and is not meant to be deployed on any production environment! If you're not a developer and just want to try out Madafrique you can check our [live demo](https://demo.Madafrique.io/).*
...
```
$ git clone https://github.com/mirumee/Madafrique-platform.git --recursive --jobs 3
```

2. We are using shared folders to enable live code reloading. Without this, Docker Compose will not start:
    - Windows/MacOS: Add the cloned `Madafrique-platform` directory to Docker shared directories (Preferences -> Resources -> File sharing).
    - Windows/MacOS: Make sure that in Docker preferences you have dedicated at least 5 GB of memory (Preferences -> Resources -> Advanced).
    - Linux: No action required, sharing already enabled and memory for Docker engine is not limited.

3. Go to the cloned directory:
```
$ cd Madafrique-platform
```
...
You can find the latest version of Madafrique, storefront and dashboard in their individual repositories:

- https://github.com/mirumee/Madafrique
- https://github.com/mirumee/Madafrique-dashboard
- https://github.com/mirumee/Madafrique-storefront
...
- Madafrique Core (API) - http://localhost:8000
- Madafrique Storefront - http://localhost:3000
- Madafrique Dashboard - http://localhost:9000
...
- https://spectrum.chat/Madafrique
- https://gitter.im/mirumee/Madafrique


## License

Disclaimer: Everything you see here is open and free to use as long as you comply with the [license](https://github.com/mirumee/Madafrique-platform/blob/master/LICENSE). There are no hidden charges. We promise to do our best to fix bugs and improve the code.
